...
if (!$serviceManagementVariables -AND !$resourceManagerVariables -AND !$oldRdfeTestVariables) {
  ...
  $env:TEST_ORGID_AUTHENTICATION = "SubscriptionId=$subscription;BaseUri=https://pt-test04.api.waptestad.onmicrosoft.com/;AADAuthEndpoint=https://login.windows.net/;GraphUri=https://graph.windows.net/"
  $env:TEST_CSM_ORGID_AUTHENTICATION = "SubscriptionId=$subscription;BaseUri=https://pt-test04:30005;AADAuthEndpoint=https://login.windows.net/"
